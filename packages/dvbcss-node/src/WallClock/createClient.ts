 ...
 *
 * @param {any} socket Socket object representing the connection
 * @param {new (protocolHandler: WallClockClientProtocol, socket: any) => T} AdaptorClass Adaptor class for the socket object
